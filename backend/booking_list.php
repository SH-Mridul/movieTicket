...
$seats = "SELECT * from booking_lists where status = 1";
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>$seat_name</td>";
                                $formattedDateTime = $row['show_time'];

                                echo "<td>$formattedDateTime</td>";
                                echo "<td>";
                              
                                echo "<a href='cancel_booking.php?id=$booking_id' class='btn btn-sm btn-danger'>cancel</a> ";
                                echo "</td>";
                                echo "</tr>";
                                $counter++;
                            }
